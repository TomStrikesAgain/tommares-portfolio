        ...
        <div className="border-4 border-accent border-dashed p-6 md:p-12 relative flex flex-col items-center">
          ...
          <div className="flex flex-col items-center text-center mt-12 mb-12">
            ...
            <motion.p 
              ...
              className="mt-6 text-lg md:text-xl font-bold uppercase tracking-widest text-secondary bg-accent px-4 py-2 inline-block shadow-lg"
            >
              {t.title}
            </motion.p>
            <motion.p
              ...
              className="mt-4 text-base md:text-lg font-bold uppercase tracking-wider text-accent/80 text-center"
            >
              {t.tagline}
            </motion.p>
          </div>
          ...
          <section className="w-full max-w-3xl text-center space-y-6 mb-16">
            <h2 className="font-anton text-3xl md:text-4xl text-secondary mb-6 tracking-wide drop-shadow-md">{t.mission_title}</h2>
            <p className="text-sm md:text-lg leading-relaxed text-accent/90">
              {t.mission_p1}
            </p>
            <p className="text-sm md:text-lg leading-relaxed text-accent/90">
              {t.mission_p2}
          ...
          <section className="w-full grid md:grid-cols-2 gap-8 mb-16">
            <div className="border-2 border-secondary bg-primary p-6 shadow-[8px_8px_0_0_#6325a6]">
              <div className="text-accent mb-4"><Zap size={32} /></div>
              <h3 className="font-anton text-xl md:text-2xl mb-3 text-accent tracking-wide">{lang === "en" ? "Building WITH AI" : "Construire AVEC l'IA"}</h3>
          ...
          <section className="w-full max-w-4xl text-left space-y-6 mb-16">
            <h2 className="font-anton text-3xl md:text-4xl text-secondary mb-6 tracking-wide drop-shadow-md">{t.case_study_title}</h2>
            <div className="bg-primary border-4 border-accent p-6 md:p-10 space-y-4 shadow-[12px_12px_0_0_#f1ecd7]">
              <h4 className="font-bold text-lg md:text-xl uppercase tracking-widest text-accent border-b-2 border-secondary pb-2 mb-4">{t.case_study_subtitle}</h4>
          ...
          {/* Human Proof */}
          <section className="w-full max-w-4xl text-left space-y-6 mb-16">
            <h2 className="font-anton text-3xl md:text-4xl text-secondary mb-6 tracking-wide drop-shadow-md text-right">{t.leadership_title}</h2>
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6 mt-8">
            <Link 
              ...
              className="font-anton text-lg bg-secondary text-accent px-6 py-3 uppercase tracking-widest hover:bg-accent hover:text-primary transition-colors border-2 border-accent flex items-center justify-center gap-2"
            >
              {t.view_bandmath} <ChevronRight />
            </Link>
            <Link 
              href="/video-production" 
              className="font-anton text-lg bg-transparent text-accent border-2 border-secondary px-6 py-3 uppercase tracking-widest hover:bg-secondary transition-colors flex items-center justify-center gap-2"
            >
